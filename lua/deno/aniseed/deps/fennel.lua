package.preload["deno.aniseed.fennel.repl"] = package.preload["deno.aniseed.fennel.repl"] or function(...)
  local utils = require("deno.aniseed.fennel.utils")
  local parser = require("deno.aniseed.fennel.parser")
  local compiler = require("deno.aniseed.fennel.compiler")
  local specials = require("deno.aniseed.fennel.specials")
  local view = require("deno.aniseed.fennel.view")
  ...
  commands.find = function(env, read, on_values, on_error, scope)
    local function _675_(_241)
      ...
      if ((_G.type(_676_) == "table") and (nil ~= (_676_).short_src) and (nil ~= (_676_).source) and ((_676_).what == "Lua") and (nil ~= (_676_).linedefined)) then
...
package.preload["deno.aniseed.fennel.specials"] = package.preload["deno.aniseed.fennel.specials"] or function(...)
  local utils = require("deno.aniseed.fennel.utils")
  local view = require("deno.aniseed.fennel.view")
  local parser = require("deno.aniseed.fennel.parser")
  local compiler = require("deno.aniseed.fennel.compiler")
  ...
  local function sandbox_fennel_module(modname)
    if ((modname == "deno.aniseed.fennel.macros") or (package and package.loaded and ("table" == type(package.loaded[modname])) and (package.loaded[modname].metadata == compiler.metadata))) then
...
package.preload["deno.aniseed.fennel.compiler"] = package.preload["deno.aniseed.fennel.compiler"] or function(...)
  local utils = require("deno.aniseed.fennel.utils")
  local parser = require("deno.aniseed.fennel.parser")
  local friend = require("deno.aniseed.fennel.friend")
  local unpack = (table.unpack or _G.unpack)
  local scopes = {}
...
package.preload["deno.aniseed.fennel.friend"] = package.preload["deno.aniseed.fennel.friend"] or function(...)
  local utils = require("deno.aniseed.fennel.utils")
...
package.preload["deno.aniseed.fennel.parser"] = package.preload["deno.aniseed.fennel.parser"] or function(...)
  local utils = require("deno.aniseed.fennel.utils")
  local friend = require("deno.aniseed.fennel.friend")
  local unpack = (table.unpack or _G.unpack)
...
local utils
package.preload["deno.aniseed.fennel.view"] = package.preload["deno.aniseed.fennel.view"] or function(...)
...
package.preload["deno.aniseed.fennel.utils"] = package.preload["deno.aniseed.fennel.utils"] or function(...)
  local view = require("deno.aniseed.fennel.view")
  local version = "1.2.0"
...
utils = require("deno.aniseed.fennel.utils")
local parser = require("deno.aniseed.fennel.parser")
local compiler = require("deno.aniseed.fennel.compiler")
local specials = require("deno.aniseed.fennel.specials")
local repl = require("deno.aniseed.fennel.repl")
local view = require("deno.aniseed.fennel.view")
...
do
  ...
  local module_name = "deno.aniseed.fennel.macros"
  local _
