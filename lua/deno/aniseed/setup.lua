...
local _2amodule_name_2a = "deno.aniseed.setup"
local _2amodule_2a
do
...
local a, env, eval, nvim = autoload("deno.aniseed.core"), autoload("deno.aniseed.env"), autoload("deno.aniseed.eval"), autoload("deno.aniseed.nvim")
