...
local _2amodule_name_2a = "deno.aniseed.env"
local _2amodule_2a
do
...
local compile, fennel, fs, nvim = autoload("deno.aniseed.compile"), autoload("deno.aniseed.fennel"), autoload("deno.aniseed.fs"), autoload("deno.aniseed.nvim")
