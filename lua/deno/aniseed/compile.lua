...
local _2amodule_name_2a = "deno.aniseed.compile"
local _2amodule_2a
do
...
local a, fennel, fs, nvim = autoload("deno.aniseed.core"), autoload("deno.aniseed.fennel"), autoload("deno.aniseed.fs"), autoload("deno.aniseed.nvim")
do end (_2amodule_locals_2a)["a"] = a
_2amodule_locals_2a["fennel"] = fennel
_2amodule_locals_2a["fs"] = fs
_2amodule_locals_2a["nvim"] = nvim
local function wrap_macros(code, opts)
  local macros_module = "deno.aniseed.macros"
  local filename
  do
