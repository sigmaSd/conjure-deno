...
local _2amodule_name_2a = "deno.aniseed.fennel"
local _2amodule_2a
do
...
local a, fs, nvim, str = autoload("deno.aniseed.core"), autoload("deno.aniseed.fs"), autoload("deno.aniseed.nvim"), autoload("deno.aniseed.string")
...
local function impl()
  local compiler = require("deno.aniseed.deps.fennel")
