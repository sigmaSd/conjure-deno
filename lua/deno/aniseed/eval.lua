...
local _2amodule_name_2a = "deno.aniseed.eval"
local _2amodule_2a
do
...
local a, compile, fennel, fs, nvim = autoload("deno.aniseed.core"), autoload("deno.aniseed.compile"), autoload("deno.aniseed.fennel"), autoload("deno.aniseed.fs"), autoload("deno.aniseed.nvim")
